    ...
    return(
        <div>
            ...
            <form className='form' onSubmit={ handleSubmit }>
                ...
                <input required type='text' placeholder='Cidade' value={cidade} onChange={e => setCidade(e.target.value)}/>
                <input required type='text' placeholder='CEP' value={cep} onChange={e => setCep(e.target.value)}/>
                <input required type='number' placeholder='ID Equipe' value={id} onChange={e => setId(e.target.value)}/>
